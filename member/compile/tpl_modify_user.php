...
<input type="hidden" class="edit" name="staffId" value="<?php echo $this->_tpl_vars["staff"]["0"]["staffId"];?>" >
    	...
    	<div class="detailMember_nav">基本信息</div>
                    <div class="detailMember_txt">帐号</div>
                        <div class="detailMember_info"><input type="text" id="staffNom" name="para[staffNo]" value="<?php echo $this->_tpl_vars["staff"]["0"]["staffNo"];?>" readonly/></div>
                
                        <div class="detailMember_txt">昵称</div>
                            <div class="detailMember_info"><input type="text" class="edit" name="para[staffName]" value="<?php echo $this->_tpl_vars["staff"]["0"]["staffName"];?>"></div>
                   ...
                   <select class="edit" name="para[sex]">
                    ...
                    <div class="detailMember_txt">出生日期</div>
                            <div class="detailMember_info"><input type="text" class="edit" name="para[birthDay]" value="<?php echo $this->_tpl_vars["staff"]["0"]["birthDay"];?>" onfocus="calendar();" format="y-m-d" msg="生日日期错误，正确的为 年-月-日"></div> 
   ...
   <div class="detailMember_nav">联系信息</div>
            ...
            <div class="detailMember_txt">邮箱地址</div>
                        <div class="detailMember_info"><input type="text" class="edit" name="para[email]" value="<?php echo $this->_tpl_vars["staff"]["0"]["email"];?>" dataType="Email" msg="信箱格式不正确"></div>
   ...
   <div class="detailMember_nav">安全信息</div>
    ...
    <div class="detailMember_txt">安全问题</div>
        	<div class="detailMember_info"> <input type="text" class="edit" name="para[safetyQuestion]" value="<?php echo $this->_tpl_vars["staff"]["0"]["safetyQuestion"];?>" dataType="Require" msg="安全问题不能为空！"></div>  
                   
    <div class="detailMember_txt">问题答案</div>
   	  <div class="detailMember_info"> <input type="text" class="edit" name="para[questionResult]" value="<?php echo $this->_tpl_vars["staff"]["0"]["questionResult"];?>" dataType="Require" msg="问题答案不能为空！"></div>   

   
    <div class=""><input type="submit" value="保存" />
    <input type="button" value="取消" class="button" onClick="location.href='index.php<?php echo runFunc('encrypt_url',array('action=member&method=detailMember'));?>';"></div>
    </form>     
    </div>
  <br />
  <div style="clear:both"></div>
