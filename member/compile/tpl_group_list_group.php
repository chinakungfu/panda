...
function search()
{
	...
	<?php $this->_tpl_vars["tempUrl"]='action=group&method=frameListGroup&mode='.$this->_tpl_vars["mode"]; ?>
	document.all.listInfo.src = "index.php<?php echo runFunc('encrypt_url',array($this->_tpl_vars["tempUrl"]));?>&sqlCon="+sqlConStr;
	//document.all.listInfo.src = "index.php?action=group&method=frameListGroup&mode=<?php echo $this->_tpl_vars["mode"];?>&sqlCon="+sqlConStr;
}
</script>
</head>
<body>
  ...
  <?php $this->_tpl_vars["tempUrl"]='action=group&method=frameListGroup&appName=' .$this->_tpl_vars["appName"] .'&isText=' .$this->_tpl_vars["isText"] .'&mode='.$this->_tpl_vars["mode"]; ?>
