...
function adddata()
{
	document.forms[0].action.value="operation";
...
function checkdata()
{
	...
	for(i=0;i<chks.length;i++){
		if(chks[i].checked){
			document.forms[0].operationId.value=chks[i].value;
			bool=1;
			break;
		}
	}
...
<div class="main_content">
   	<div class="main_content_nav">后台管理系统 >> 操作管理</div>
...
<div class="search_content detailMember">
 ...
 <form action="index.php" method="POST">  
  ...
  <input type="hidden" name="operationId">
    ...
    <?php $this->_tpl_vars["result"]=runFunc('listOperation',array($this->_tpl_vars["sqlCon"],'')); ?>
    <table class="tableList" border="1" id="list" width="100%">    
      <tr>
      		<td class="listHeader">选中</td>
          	
          	<td class="listHeader">操作标识</td>
          	<td class="listHeader">操作名称</td>
          	<td class="listHeader">应用Id</td>
      		<td class="listHeader">模块Id</td>
      		<td class="listHeader">动作Id</td>
      		<td class="listHeader">内容标识</td>
      		<td class="listHeader">级别标识</td>
      		<td class="listHeader">是否二级权限</td>
 ...
 foreach ($this->_tpl_vars["result"]["data"] as $this->_tpl_vars['key']=>$this->_tpl_vars['var']){ ?>
       <tr>
          <td class="tdListItem"><input type="checkbox" name="checks" value="<?php echo $this->_tpl_vars["var"]["operationId"];?>" onclick="selectConCheck();"></td>
          
          <td class="tdListItem"><?php echo $this->_tpl_vars["var"]["operationNo"];?></td>
          <td class="tdListItem"><?php echo $this->_tpl_vars["var"]["operationName"];?></td>
          <td class="tdListItem"><?php echo $this->_tpl_vars["var"]["appId"];?></td>
          <td class="tdListItem"><?php echo $this->_tpl_vars["var"]["moduleId"];?></td>
          <td class="tdListItem"><?php echo $this->_tpl_vars["var"]["actionId"];?></td>
          <td class="tdListItem"><?php echo $this->_tpl_vars["var"]["contentFlag"];?></td>
          <td class="tdListItem"><?php echo $this->_tpl_vars["var"]["distinctionNo"];?></td>
          <td class="tdListItem">
          <?php if ($this->_tpl_vars["var"]["isSecondAuth"] =='1'){?>
			是
          <?php }else{ ?>
          	否
          <?php } ?>
