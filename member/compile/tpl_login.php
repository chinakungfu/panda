...
<table cellpadding="0" cellspacing="0" width="650" height="auto" align="center">
	<tr><td height="100" style="font-size:30px; font-weight:bold; color:#2F5A6E; text-align:center; border-bottom:1px solid #2F5A6E;">WOWSHOPPING后台管理系统v1.0</td></tr>
...
<table cellpadding="0" cellspacing="0" width="100%" align="center">
    <tr>
      ...
      <td width="8"></td>
      <td width="auto"><input name="staffNo" type="text" value="<?php echo $this->_tpl_vars["IN"]["staffNo"];?>" style="border:0px;" tabindex="1"/></td>
    </tr>
</table>
                            </td></tr>
...
<table cellpadding="0" cellspacing="0" width="100%" align="center">
    <tr>
      ...
      <td width="57"><img src='../web-inf/lib/core/apprun/member/buildCode.php' border=0 align=absbottom alt="验证码由纯数字组成"></td>
                            ...
                            <tr><td height="8"></td></tr>
                            <tr><td height="auto"><!-- <a href="index.php<?php echo runFunc('encrypt_url',array('action=member&method=findPassword'));?>" tabindex="5"><font style="font-size:12px; color:#0767a8;">忘记密码请点击此处</font></a> --></td></tr>
                      </table>    
                    </td>
                	  <td width="2%"></td>
                	  <td width="23%">
