...
<pp:var name="result" value="@StaffIsExists($staffNo)"/>
<pp:if expr="$result">
<table cellpadding="0" cellspacing="0" width="100%" align="center">
...
<table cellpadding="0" cellspacing="0" width="100%" align="center">
    <tr>
      ...
      <td width="8"></td>
      <td width="auto"><input name="staffNo" type="text" value="[$result.0.staffNo]" readonly dataType="Username" msg="请填写用户名" style="border:0px;"/></td>
    </tr>
</table>
                            </td></tr>
...
<table cellpadding="0" cellspacing="0" width="100%" align="center">
    <tr>
      ...
      <td width="auto"><input name="questionResult" type="text" dataType="Require" msg="答案不能为空！" style="border:0px;"/></td>
           ...
           <input type="button" value="返回" class="button" onClick="location.href='index.php[@encrypt_url('action=member&method=login')]';"></td></tr>
                      </table>
<pp:else/>
<script>alert("账户名不正确或不存在！");location.href="index.php[@encrypt_url('action=member&method=findPassword')]"</script>
</pp:if>
