...
<div class="search_content detailMember">
 ...
 <form action="index.php" method="POST">  
  ...
  <input type="hidden" name="operationId">
    <table width="100%" id="editgroup">
      <tr>
        ...
        <!--<input type="button" id="select" value="查询" onClick="parent.search();">&nbsp;&nbsp;-->
          ...
          <input type="button" class="button1" value="导 出" name="btnexport" onClick="AutomateExcel(list);">
    ...
    <pp:var name="result" value="<pp:memfunc funcname="listOperation($sqlCon,'')"/>"/>
    <table class="tableList" border="1" id="list" width="100%">    
      <tr>
      		<td class="listHeader">选中</td>
          	<!--<td class="listHeader">操作Id</td>-->
       ...
       <tr>
          <td class="tdListItem"><input type="checkbox" name="checks" value="[$var.operationId]" onclick="selectConCheck();"></td>
          <!--<td class="tdListItem">[$var.operationId]</td>-->
          <td class="tdListItem">[$var.operationNo]</td>
          <td class="tdListItem">[$var.operationName]</td>
          <td class="tdListItem">[$var.appId]</td>
          <td class="tdListItem">[$var.moduleId]</td>
          <td class="tdListItem">[$var.actionId]</td>
          <td class="tdListItem">[$var.contentFlag]</td>
          <td class="tdListItem">[$var.distinctionNo]</td>
          <td class="tdListItem">
          <if expr="$var.isSecondAuth =='1'">
			是
          <else/>
          	否
          </if>
