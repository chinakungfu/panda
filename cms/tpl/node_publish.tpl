...
<input type="hidden" name="method" value="saveNodePublish">
<input type="hidden" class="edit" name="nodeId" value="[$nodeId]">
<input type="hidden" class="edit" name="allSit" value="[$allSit]">
		<div class="detailMember_nav">发布内容</div>
		...
		<div class="detailMember_nav">发布选项</div>
			<input type="radio" name="isMandatory" value="0">发布未发布
			<input type="radio" name="isMandatory" value="1">完全发布<br>
			<input type='checkbox' id="subNode" name='subNode' value="subNode">子结点发布<br>
			单次循环更新内容页数<input type='text' id="counter" name='counter' value="10">
			</div>
    <div class="detailMember_doedit"><input type="submit" value="开始发布" /><input type="button" value="取消" class="button" onClick="window.close();"></div>
    </form>     
    </div>
  <br />
