...
<pp:if expr="$method=='addField'">
<input type="hidden" name="method" value="saveAddField">
<input type="hidden" class="edit" name="fieldId" value="">
<input type="hidden" class="edit" name="para[fieldConfigId]" value="[$fieldConfigId]">
<div class="main_content">
   	<div class="main_content_nav">当前位置：系统管理>>字段配置管理>>新建字段</div>
   	<div style="clear:both"></div>
<div class="search_content detailMember">
<pp:else/>
<pp:var name="field" value="@getFieldInfoById($fieldId)"/>
<input type="hidden" name="method" value="saveEditField">
<input type="hidden" class="edit" name="fieldId" value="[$field.0.fieldId]" >
<input type="hidden" class="edit" name="para[fieldConfigId]" value="[$field.0.fieldConfigId]">
<div class="main_content">
...
<div class="search_content detailMember">
		...
		<div class="detailMember_nav">新建字段</div>
			...
			<div class="detailMember_info"><input type="text" id="fieldTitle" name="para[fieldTitle]" value="[$field.0.fieldTitle]"></div>
			<div class="detailMember_txt">字段名：</div>
			<div class="detailMember_info"><input type="text" id="fieldName" name="para[fieldName]" value="[$field.0.fieldName]"></div>
			...
			<div class="detailMember_info"><input type="text" id="tableHeadWidth" name="para[tableHeadWidth]" value="[$field.0.tableHeadWidth]">px</div>
			...
			<div class="detailMember_info"><input type="text" id="fieldSize" name="para[fieldSize]" value="[$field.0.fieldSize]"></div>
			...
			<div class="detailMember_info">
			<input type="text" id="fieldDefaultValue" name="para[fieldDefaultValue]" value="[$field.0.fieldDefaultValue]">多个可选值之间以分号分隔如：aaa:bbb;ccc:ddd或aaa;ccc
			</div>
			...
			<div class="detailMember_info">
			<input type="text" id="fieldInputTpl" name="para[fieldInputTpl]" value="[$field.0.fieldInputTpl]">
			...
			<div class="detailMember_info">
			<textarea id="fieldDescription" name="para[fieldDescription]" cols="50" rows="5" tabindex="8">[$field.0.fieldDescription]</textarea>
			</div>
...
<script>
radioIsSelected('publishMode','[$field.0.publishMode]');
radioIsSelected('isDisplayHeader','[$field.0.isDisplayHeader]');
radioIsSelected('isDisplayEdit','[$field.0.isDisplayEdit]');
jsSelectValue("fieldType",'[$field.0.fieldType]');
jsSelectValue("fieldInput",'[$field.0.fieldInput]');
jsSelectValue("fieldInputFilter",'[$field.0.fieldInputFilter]');
jsSelectValue("fieldInputPicker",'[$field.0.fieldInputPicker]');
</script>
</body>
</html>
