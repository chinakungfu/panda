...
<script language="javascript" src="skin/jsfiles<b></b>/cms.js"></script>
</head>
...
<input type="hidden" name="method" value="batchBest">
...
<div class="main_content">
   	<div class="main_content_nav">内容精华设置</div>
   	<div style="clear:both"></div>
<div class="search_content detailMember">   		
			<div class="detailMember_txt">精华权重：</div>
			<div class="detailMember_info">
			<input type="text" id="pink" name="para[pink]" value="">
			</div>
