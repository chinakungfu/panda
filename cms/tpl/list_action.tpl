...
<pp:var name="contentPlan" value="@getContentPlanInfoById($contentPlanId)"/>
<div class="detailMember_nav">新建内容编辑方案</div>
	<div class="detailMember_txt">内容编辑方案名称：</div>
	<div class="detailMember_info"><input type="text" name="para[contentPlanName]" value="[$contentPlan.0.contentPlanName]" ></div>
	<div class="detailMember_txt">内容编辑分页数：</div>
	<div class="detailMember_info"><input type="text" name="para[contentPlanPage]" value="[$contentPlan.0.contentPlanPage]" ></div>
	<div class="detailMember_txt">内容编辑分页长度：</div>
	<div class="detailMember_info"><input type="text" name="para[contentPlanSize]" value="[$contentPlan.0.contentPlanSize]" ></div>
	...
	<table border="0">
		<tr>
			<td>待选动作<br>
				<input type="hidden" name="para[headerActionId]" id="headerActionId" value="[$contentPlan.0.headerActionId]">
				...
				<pp:var name="checkActionExist" value="@checkActionExist($var.actionGuid,$contentPlan.0.headerActionId)"/>
				<pp:if expr="!$checkActionExist">
			...
			<td>选定动作<br>
				...
				<pp:var name="result" value="@getContentActionBycontentId($contentPlanId,'headerActionId')"/>	
				<loop name="result"  var="var" key="key">
				<pp:var name="actionResult" value="@getActionInfoByGuid($var)"/>
					<pp:if expr="$actionResult.0.actionTitle">
						<option value="[$var]">[$actionResult.0.actionTitle]</option>
					</pp:if>
				</loop>	
				</select>
			</td>
	...
	<table border="0">
		<tr>
			<td>待选动作<br>
				<input type="hidden" name="para[rightActionId]" id="rightActionId" value="[$contentPlan.0.rightActionId]">
				...
				<pp:var name="result" value="@listActionInfo()"/>
				<loop name="result.data"  var="var" key="key">
				<pp:var name="checkActionExist" value="@checkActionExist($var.actionGuid,$contentPlan.0.rightActionId)"/>
				<pp:if expr="!$checkActionExist">
					<option value="[$var.actionGuid]">[$var.actionTitle]</option>
				</pp:if>
				</loop>
			...
			<td>选定动作<br>
				...
				<pp:var name="result" value="@getContentActionBycontentId($contentPlanId,'rightActionId')"/>	
				<loop name="result"  var="var" key="key">
				<pp:var name="actionResult" value="@getActionInfoByGuid($var)"/>
					<pp:if expr="$actionResult.0.actionTitle">
						<option value="[$var]">[$actionResult.0.actionTitle]</option>
	...
	<table border="0">
		<tr>
			<td>待选动作<br>
				<input type="hidden" name="para[contentActionId]" id="contentActionId" value="[$contentPlan.0.contentActionId]">
				...
				<pp:var name="result" value="@listActionInfo()"/>
				<loop name="result.data"  var="var" key="key">
				<pp:var name="checkActionExist" value="@checkActionExist($var.actionGuid,$contentPlan.0.contentActionId)"/>
				<pp:if expr="!$checkActionExist">
					<option value="[$var.actionGuid]">[$var.actionTitle]</option>
				</pp:if>
				</loop>
			...
			<td>选定动作<br>
				...
				<pp:var name="result" value="@getContentActionBycontentId($contentPlanId,'contentActionId')"/>	
				<loop name="result"  var="var" key="key">
				<pp:var name="actionResult" value="@getActionInfoByGuid($var)"/>
					<pp:if expr="$actionResult.0.actionTitle">
						<option value="[$var]">[$actionResult.0.actionTitle]</option>
	...
	<table border="0">
		<tr>
			<td>待选动作<br>
				<input type="hidden" name="para[batchActionId]" id="batchActionId" value="[$contentPlan.0.batchActionId]">
				...
				<pp:var name="result" value="@listActionInfo()"/>
				<loop name="result.data"  var="var" key="key">
				<pp:var name="checkActionExist" value="@checkActionExist($var.actionGuid,$contentPlan.0.batchActionId)"/>
				<pp:if expr="!$checkActionExist">
					<option value="[$var.actionGuid]">[$var.actionTitle]</option>
				</pp:if>
				</loop>
			...
			<td>选定动作<br>
				...
				<pp:var name="result" value="@getContentActionBycontentId($contentPlanId,'batchActionId')"/>	
				<loop name="result"  var="var" key="key">
				<pp:var name="actionResult" value="@getActionInfoByGuid($var)"/>
					<pp:if expr="$actionResult.0.actionTitle">
						<option value="[$var]">[$actionResult.0.actionTitle]</option>
	...
	<div class="detailMember_info"><input type="text" name="para[addPre]" value="[$contentPlan.0.addPre]" ></div>
	<div class="detailMember_txt">新增之后：</div>
	<div class="detailMember_info"><input type="text" name="para[addNext]" value="[$contentPlan.0.addNext]" ></div>
	<div class="detailMember_txt">保存之前：</div>
	<div class="detailMember_info"><input type="text" name="para[savePre]" value="[$contentPlan.0.savePre]" ></div>
	<div class="detailMember_txt">保存之后：</div>
	<div class="detailMember_info"><input type="text" name="para[saveNext]" value="[$contentPlan.0.saveNext]" ></div>
	<div class="detailMember_txt">删除之前：</div>
	<div class="detailMember_info"><input type="text" name="para[delPre]" value="[$contentPlan.0.delPre]" ></div>
	<div class="detailMember_txt">删除之后：</div>
	<div class="detailMember_info"><input type="text" name="para[delNext]" value="[$contentPlan.0.delNext]" ></div>
...
<pp:memfunc funcname="listPage($result.pageinfo,'index.php','5')"/>
    <table class="tableList" border="1" id="list" width="100%">    
      <tr>
       ...
       <loop name="result.data"  var="var" key="key">
       <tr>
       		<td class="tdListItem">[$var.actionTitle]</td>
       		<td class="tdListItem">[$var.actionGuid]</td>
          	<td class="tdListItem">[$var.actionName]</td>
          	<td class="tdListItem">[$var.methodName]</td>
          	<td class="tdListItem">[$var.tplPath]</td>
          	<td class="tdListItem">
          	<pp:if expr="$var.actionType=='1'">
          	列表页动作
          	<pp:elseif expr="$var.actionType=='2'">
          	编辑页动作
          	<pp:elseif expr="$var.actionType=='3'">
          	其它页动作
          	</pp:if>
          	</td>
            <td class="tdListItem">
            <pp:var name="editUrl" value="'action=cms&method=editAction&contentPlanId='.$contentPlanId .'&actionId='.$var.actionId"/>
          	<pp:var name="delUrl" value="'action=cms&method=delAction&contentPlanId='.$contentPlanId .'&actionId='.$var.actionId"/>
