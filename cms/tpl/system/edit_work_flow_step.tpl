...
<pp:if expr="$method=='addWorkFlowStep'">
...
<pp:else/>
<pp:var name="workFlowStep" value="@getWorkFlowStepInfoById($flowStepId)"/>
<input type="hidden" name="method" value="saveEditWorkFlowStep">
<input type="hidden" class="edit" name="flowStepId" value="[$workFlowStep.0.flowStepId]" >
<div class="main_content">
...
<div class="search_content detailMember">
			...
			<div class="detailMember_info">
				<input type="text" id="flowStepName" name="para[flowStepName]" value="[$workFlowStep.0.flowStepName]">
			</div>
			<!--<div class="detailMember_txt">工作流步骤标识：</div>
			<div class="detailMember_info">
				<input type="text" id="flowStepGuid" name="para[flowStepGuid]" value="[$workFlowStep.0.flowStepGuid]">
			</div>-->
			<div class="detailMember_txt">工作流步骤说明：</div>
			<div class="detailMember_info">
				<textarea id="flowStepRemark" name="para[flowStepRemark]" value="">[$workFlowStep.0.flowStepRemark]</textarea>
			</div>
