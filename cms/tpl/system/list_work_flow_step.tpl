...
<div class="search_content detailMember">
 ...
 <form action="index.php" method="POST">  
  ...
  <input type="hidden" name="flowStepId">
    ...
    <pp:var name="result" value="<pp:memfunc funcname="listWorkFlowStep()"/>"/>
    <table class="tableList" border="1" id="list" width="100%">    
      <tr>
       ...
       <tr>
          <td class="tdListItem"><input type="checkbox" name="checks" value="[$var.flowStepId]" onclick="selectConCheck();"></td>
          <td class="tdListItem">[$var.flowStepName]</td>
          <td class="tdListItem">[$var.flowStepRemark]</td>
       </tr>
       </loop>
    </table>
