...
<div class="search_content detailMember">
 ...
 <form action="index.php" method="POST">  
  ...
  <input type="hidden" name="flowId">
    ...
    <pp:var name="result" value="<pp:memfunc funcname="listWorkFlow($sqlCon,'')"/>"/>
    <table class="tableList" border="1" id="list" width="100%">    
      <tr>
    		<td class="listHeader">选中</td>
          	<!--<td class="listHeader">工作流标识</td>-->
       ...
       <tr>
          <td class="tdListItem"><input type="checkbox" name="checks" value="[$var.flowId]" onclick="selectConCheck();"></td>
          <td class="tdListItem">[$var.flowGuid]</td>
          <td class="tdListItem">[$var.flowRemark]</td>
       </tr>
       </loop>
    </table>
