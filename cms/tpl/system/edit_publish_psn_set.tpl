...
<pp:if expr="$method=='addPublishPsn'">
...
<pp:else/>
<pp:var name="publishPsn" value="@getPublishPsnInfoById($psnId)"/>
<input type="hidden" name="method" value="saveEditPublishPsn">
<input type="hidden" class="edit" name="psnId" value="[$publishPsn.0.psnId]" >
<div class="main_content">
   	<div class="main_content_nav">当前位置：系统管理>>系统管理>>发布点(PSN)设置</div>
   	<div style="clear:both"></div>
<div class="search_content detailMember">
			...
			<input type="text" id="psnName" name="para[psnName]" value="[$publishPsn.0.psnName]">
			</div>
			<div class="detailMember_txt">
			发布点(PSN)类型:</div>
			<div class="detailMember_info">
			...
			<div class="detailMember_info">
			<input type="text" id="psn" name="para[psn]" value="[$publishPsn.0.psn]">如：../../</div>
			<div class="detailMember_txt">URL:</div>
			<div class="detailMember_info"><input type="text" id="psnUrl" name="para[psnUrl]" value="[$publishPsn.0.psnUrl]">如：http://domain/.../</div>
			<div class="detailMember_txt">附加信息:</div>
			<div class="detailMember_info"><input type="text" id="psnDes" name="para[psnDes]" value="[$publishPsn.0.psnDes]"></div>
