...
<?php if ($this->_tpl_vars["method"]=='addModelVar'){?>
...
<?php }else{ ?>
<?php $this->_tpl_vars["modelVar"]=runFunc('getModelVarInfoById',array($this->_tpl_vars["varId"])); ?>
<input type="hidden" name="method" value="saveEditModelVar">
<input type="hidden" class="edit" name="varId" value="<?php echo $this->_tpl_vars["modelVar"]["0"]["varId"];?>" >
<div class="main_content">
   	<div class="main_content_nav">当前位置：系统管理>>系统管理>>模板变量设置</div>
   	<div style="clear:both"></div>
<div class="search_content detailMember">
<?php } ?>        	
			...
			<div class="detailMember_info"><input type="text" id="varTitle" name="para[varTitle]" value="<?php echo $this->_tpl_vars["modelVar"]["0"]["varTitle"];?>"></div>
			<div class="detailMember_txt">变量名：</div>
			<div class="detailMember_info"><input type="text" id="varName" name="para[varName]" value="<?php echo $this->_tpl_vars["modelVar"]["0"]["varName"];?>"></div>
			<div class="detailMember_txt">变量值：</div>
			<div class="detailMember_info"><input type="text" id="varValue" name="para[varValue]" value="<?php echo $this->_tpl_vars["modelVar"]["0"]["varValue"];?>"></div>
