...
$items = runFunc("adminGetPolls",array($this->_tpl_vars["IN"]["page"],15,false,$this->_tpl_vars["IN"]["sort"],$this->_tpl_vars["IN"]["key"],$this->_tpl_vars["IN"]["status"],$this->_tpl_vars["IN"]["search_word"]));
	
$count = runFunc("adminGetPolls",array($this->_tpl_vars["IN"]["page"],15,true,$this->_tpl_vars["IN"]["sort"],$this->_tpl_vars["IN"]["key"],$this->_tpl_vars["IN"]["status"],$this->_tpl_vars["IN"]["search_word"]));
...
<div class="cms_right fr">
	<div class="ctrl_bar">
		...
		<ul class="fr ctrl_link">
			...
			<li id="ctrl_4">
				<a href="#" class="batch_delete" delete="poll">批量删除</a>
			</li>
			<li id="ctrl_5"><a href="<?php echo runFunc('encrypt_url',array('action=cms&method=poll_recycle&type=share'));?>">回收站</a></li>
		</ul>
	</div>
<div class="search_bar">
	...
	<table class="order_list <?php if(($i++%2)==""){echo "pink";}?>">
		<tr>
			...
			<td width="10%"><a href="<?php echo runFunc('encrypt_url',array('action=cms&method=poll_show&id='.$item["id"].'&type=share'));?>">查看</a> | <a onClick="javascript:return confirm('是否确认删除该投票？')" href="<?php echo runFunc('encrypt_url',array('action=cms&method=poll_delete&id='.$item["id"]));?>">删除</a></td>
		</tr>
	</table>
	<?php endforeach;
	else:
