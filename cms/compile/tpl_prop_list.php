...
<?php $items = runFunc("getItemList",array("cms_product_prop",$page,20,false));
$items_count = runFunc("getItemList",array("cms_product_prop",1,20,true));
...
<div class="ctrl_bar">
		...
		<ul class="fr ctrl_link">
			<li id="ctrl_4">
				<a href="#" class="batch_delete" delete="prop">批量删除</a>
			</li>
		</ul>
	</div>
...
<table class="order_list <?php if(($i++%2)==""){echo "pink";}?>">
	<tbody>
		<tr>
			...
			<td width="35%"><a href="<?php echo runFunc('encrypt_url',array('action=cms&method=prop_edit&type=products&id='.$item["id"]));?>">编辑</a> <a onClick="javascript: return confirm('是否确认删除这个此项？')" href="<?php echo runFunc('encrypt_url',array('action=cms&method=product_delete&delete_type=prop&id='.$item["id"]));?>">删除</a></td>
		</tr>
	</tbody>
</table>
<?php endforeach;?>
