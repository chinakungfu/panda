...
<table style="margin:auto;width:540px;margin-top:15px;text-align:center;font-size:12px;" id="items_preview_table">
	...
	<div class="gray_line_box">
		...
		<div class="request_items">
			...
			<table class="admin_edit_table">
				<tr>
					<th>标题</th>
					<td><input type="text" name="letter_title" id="letter_title" class="dark_border input_bar_long required"/></td>
				</tr>
				<tr>
					<th>抓取商品URL</th>
					<td>
