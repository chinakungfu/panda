...
<body>
<?php if ($this->_tpl_vars["IN"]["multNodeId"]!=null){?>
<?php $this->_tpl_vars["xmlFile"]=runFunc('exportNode',array($this->_tpl_vars["IN"]["multNodeId"])); ?>
...
<form method="post" action="index.php" id="form1">
	...
	<?php echo runFunc('exportListNode',array());?>
