			...
			<table class="admin_edit_table">
				...
				<tr>
					...
					<?php foreach($cats as $cat):?>
						<option value="<?php echo $cat["id"]?>"><?php echo $cat["name"]?><?php if($cat["published"]==0)echo"(未发布)";?></option>
					<?php endforeach;?>
					</select>
				</td>
				</tr>
				...
				<tr>
					<th>网址</th>
					<td><input type="text" name="link" id="link" class="dark_border input_bar_long required"/></td>
				</tr>
				<tr>
					<th>LOGO</th>
