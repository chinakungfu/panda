...
<div class="ctrl_bar">
		...
		<ul class="fr ctrl_link">
			...
			<li id="ctrl_2"><a href="index.php<?php echo runFunc('encrypt_url',array('action=cms&method=product_list_outside&type=products&status='.$status.'&page='.$page));?>">取消</a></li>
		</ul>
	</div>
	<div class="gray_line_box">
		...
		<input type="hidden" name="method" value="product_save_outside" />
		...
		<input type="hidden" id="page" name="page" value="<?php echo $page;?>"/>
			<table class="admin_edit_table">
				<tr>
					<th>商品名称</th>
					<td ><input type="text" name="title" id="title" class="dark_border input_bar_long" value="<?php echo $item["goodsTitleCN"]?>"/></td>
				</tr>
				<tr>
					<th>商品英文名称</th>
				...
				<tr>
					<th>店铺ID</th>
					<td ><input type="text" name="goodsShopId" id="goodsShopId" class="dark_border input_bar_long" value="<?php echo $item["goodsShopId"]?>"/></td>
				</tr>
				<tr>
					<th>店铺名称</th>
				...
				<tr>
					<th>商品URL</th>
					<td >
						<input type="text" name = "goodsURL" id="goodsURL" class="dark_border input_bar_long" value="<?php echo $item["goodsURL"];?>" />
					</td>
				</tr>

				<?php if(trim($item["click_url"])!=""):?>
				<tr>
					<th>click URL</th>
					<td >
						<input type="text" name = "click_url" id="click_url"  class="dark_border input_bar_long" value="<?php echo $item["click_url"];?>" />
