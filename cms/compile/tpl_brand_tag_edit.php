...
$item = runFunc("getAdminBrandTag",array($this->_tpl_vars["IN"]["id"]));
?>
...
<div class="ctrl_bar">
		...
		<ul class="fr ctrl_link">
			...
			<li id="ctrl_2"><a href="index.php<?php echo runFunc('encrypt_url',array('action=cms&method=brand_tag_list&type=products'));?>">取消</a></li>
		</ul>
	</div>
	<div class="gray_line_box">
		...
		<input type="hidden" name="method" value="brand_tag_save" />
