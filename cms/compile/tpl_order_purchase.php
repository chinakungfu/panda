...
runFunc("orderPurchase",array($this->_tpl_vars["IN"]["orderId"]));
...
runFunc('sendMail',array($mailArray,"order_purchase"));


$this->_tpl_vars["name"]=runFunc('readSession',array());
runFunc("makeAdminLog",array("普通订单 ".$order["OrderNo"]."商品采购",$this->_tpl_vars["name"]));
...
echo '<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01//EN" "http://www.w3.org/TR/html4/strict.dtd">
	...
	<body>
		<script type="text/javascript">alert("商品采购确认成功!");
