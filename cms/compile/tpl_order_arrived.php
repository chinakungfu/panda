...
runFunc("confirmArrived",array($this->_tpl_vars["IN"]["orderId"]));
...
runFunc('sendMail',array($mailArray,"order_arrived"));

$this->_tpl_vars["name"]=runFunc('readSession',array());
runFunc("makeAdminLog",array("普通订单 ".$order["OrderNo"]."已送达",$this->_tpl_vars["name"]));
...
echo '<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01//EN" "http://www.w3.org/TR/html4/strict.dtd">
	...
	<body>
		<script type="text/javascript">alert("商品已送达!");
