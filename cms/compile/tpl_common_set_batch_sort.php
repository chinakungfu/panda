...
<input type="hidden" name="method" value="batchSort">
...
<div class="main_content">
   	<div class="main_content_nav">内容权重设置</div>
   	<div style="clear:both"></div>
<div class="search_content detailMember">   
			<div class="detailMember_txt">权重权重：</div>
			<div class="detailMember_info">
			<input type="text" id="sort" name="para[sort]" value="">
			</div>
