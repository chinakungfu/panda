...
<?php } elseif ($this->_tpl_vars["method"]=='nodeBase'){ ?>
	...
	<input type="button" value="取消" class="button" onClick="window.close();">
<?php } elseif ($this->_tpl_vars["method"]=='copy'){ ?>
	<input type="hidden" name="method" value="saveCopy">
	<input type="hidden" class="edit" name="appTableKeyName" id="appTableKeyName" value="<?php echo $this->_tpl_vars["appTableKeyName"];?>" >
	<input type="hidden" class="edit" name="contentModel" id="contentModel" value="<?php echo $this->_tpl_vars["contentModel"];?>" >
	<input type="hidden" class="edit" name="selectConId" id="selectConId" value="<?php echo $this->_tpl_vars["selectConId"];?>" >
	<input type="hidden" class="edit" name="nodeId" id="nodeId" value="<?php echo $this->_tpl_vars["nodeId"];?>" >
	<input type="hidden" class="edit" name="parentId" id="parentId" value="" >
	<div id="nodeList">    
	</div> 
	...
	<input type="button" value="取消" class="button" onClick="window.close();">
<?php } elseif ($this->_tpl_vars["method"]=='move'){ ?>
