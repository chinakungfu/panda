...
<div class="search_content detailMember">
 ...
 <form action="index.php" method="POST">  
  ...
  <input type="hidden" name="flowActionId">
    ...
    <?php $this->_tpl_vars["result"]=runFunc('listWorkFlowAction',array()); ?>
 ...
 foreach ($this->_tpl_vars["result"]["data"] as $this->_tpl_vars['key']=>$this->_tpl_vars['var']){ ?>
       <tr>
          <td class="tdListItem"><input type="checkbox" name="checks" value="<?php echo $this->_tpl_vars["var"]["flowActionId"];?>" onclick="selectConCheck();"></td>
          <td class="tdListItem"><?php echo $this->_tpl_vars["var"]["flowActionName"];?></td>
          <td class="tdListItem"><?php echo $this->_tpl_vars["var"]["flowActionRemark"];?></td>
       </tr>
       <?php  }
} ?>
    </table>
