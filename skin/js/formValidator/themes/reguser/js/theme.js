//提示层的HTML
var onShowHtml = '';
var onFocusHtml = '<P class="noticeWrap"><B class="ico-foucs"></B><SPAN class=txt-foc>$data$</SPAN></P>';
...
'<P id=passStrong class="pswState"><EM class=st1>Weak</EM><B class="progressImage prog0"></B><EM class=st2>Strong</EM></P>',
'<P id=passStrong class="pswState"><EM class=st1>Weak</EM><B class="progressImage prog1"></B><EM class=st2>Strong</EM></P>',
'<P id=passStrong class="pswState"><EM class=st1>Weak</EM><B class="progressImage prog2"></B><EM class=st2>Strong</EM></P>',
'<P id=passStrong class="pswState"><EM class=st1>Weak</EM><B class="progressImage prog3"></B><EM class=st2>Strong</EM></P>'
							  ];

var passwordStrengthText = ['Weak','Medium','Strong']
