...
class extendedPDataAccess extends extendedDataAccess
{
	...
	public function getConnection()
	{
		try
		{
			...
			$this->connection=new PDO($connstring,$this->loginName,$this->loginPassword);
	...
	public  function getConnectionString()
	{
		...
		}else if($this->dbtype=='mssql')//mssql数据库
		{
			$connectionString='mssql:host='.$this->serverName.';dbname='.$this->dbName;
