...
import('core.easyopenid.Services.Yadis.PlainHTTPFetcher');
import('core.easyopenid.Services.Yadis.ParanoidHTTPFetcher');
import('core.easyopenid.Services.Yadis.ParseHTML');
/**
 * Need this to parse the XRDS document during Yadis discovery.
 */
//require_once "Services/Yadis/XRDS.php";
import('core.easyopenid.Services.Yadis.XRDS');
