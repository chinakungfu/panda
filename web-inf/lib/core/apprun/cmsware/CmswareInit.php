 ...
 * 基础配置文件
 */
$cms_config['table_prefix'] = 'cmsware_';
...
$db_config['db_password'] = 'cluster';  //数据库用户密码	
$db_config['db_name']     = 'miigzbs';      //数据库名		
