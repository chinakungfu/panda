...
var PopupLayer = new Class({
	...
	_construct:function(){                  //构造弹出层
		this.popupBlk.show();
		this.popupLayer.append(this.popupBlk.css({opacity:1})).appendTo($(document.body)).css({position:"absolute",'z-index':2,width:300,height:357});
	...
	close:function(){                 //关闭方法
		...
		//document.getElementById('dataStr').style.display='none';
