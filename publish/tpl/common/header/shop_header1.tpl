...
<cms action="sql" return="headCartList" query="SELECT count(*) as countRows FROM cms_publish_cart a,cms_publish_goods b WHERE  a.ItemGoodsID=b.goodsid and a.UserName='{$tmpUser}' and a.ItemStatus = 'New' Order By a.cartid DESC" />
...
<pp:if expr="$action=='share'">
	<div class="sharemain clb">
		<pp:if expr="$name!=''">
			 ...
			 <li><a href="index.php[@encrypt_url('action=share&method=yourFriends')]">YOURFRIENDS</a></li>
		...
		<div class="viewShoppingBagCont" id="dataStr1" style="display:none">
			...
			<loop name="cartList.data" var="var" key="key">   
				...
				<pp:if expr="$key<$cartListNum">
					<dl>
						<dt class="fl"><img src="../web-inf/lib/coreconfig/[$var.goodsImgURL]" alt="小图1" style="width:75px;height:93px" border="0"></dt>
