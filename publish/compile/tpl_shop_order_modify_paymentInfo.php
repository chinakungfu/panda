...
<div class="subMitRight fr">
	...
	<table class="subMitNameSubTotal">
		...
		<tr width="100%">
			<td align="right">¥ <b id="sub_total"><?php echo number_format($subTotal, 2, '.', ',');?></b></td>
		</tr>
	</table>
	<table class="subMitNameSubTotal" style="margin-top: 30px;">
		...
		<tr>
			<td align="right"><?php if ($freight<=0){?><b id = "freight_total">0.00</b><?php }else{ ?>
							¥ <b id = "freight_total"><?php echo number_format($freight, 2, '.', ','); ?></b>
						 <?php } ?></td>
			<td class="hide"><?php if ($freight<=0){?><b id = "freight">0</b><?php }else{ ?>
							<b id = "freight"><?php echo 1; ?></b>
						 <?php } ?></td>
		</tr>
	</table>
	<!--
 ...
 -->
	<table class="subMitNameSubTotal" style="margin-top: 30px;">
		...
		<tr>
			...
			¥ <b id="service_fee"><?php echo number_format($service_fee, 2, '.', ',');?></b>
			</td>
		</tr>
