...
<body onload="window.location.hash = 'here'">
	...
	?>
	<div class="content">
	<h2 class="cp_title">Edit Your Circles</h2>
	...
	<form id="circle_create_form" action="index.php" method="post">
		<input type="hidden" id="id" name="id" value="<?php echo $this->_tpl_vars["IN"]["id"];?>"/>
		<table class="circle_create_detail_table">
			<tr>
				<th style="line-height: 25px;vertical-align: top;"><label class="fr" for="list_name">Circles Name: *</label></th>
				<td>
				<input id="list_name" value="<?php echo $circle[0]["name"];?>" class="circle_editor_input big_input required" type="text" name="circles_name" maxlength="50">
				<br>
				<font style="font-style:italic">Maximum of 50 characters</font>	
				</td>
			</tr>
			<tr>
				<th>Photo of Circle:*</th>
				<td>
					<div class="photo_box">
					<center>
					<img src="../circles_img/<?php echo $circle[0]["user_id"];?>/<?php echo $circle[0]["img"];?>" alt="" />
					</center>
					</div>
				</td>
			</tr>
			...
			<tr>
				...
				<td>
					<textarea class="circle_text required" name="introduction" id="introduction" cols="30" rows="10"><?php echo $circle[0]["introduction"];?></textarea>
			...
			<tr>
				...
				<option value="">Select your circle about</option>
				<?php foreach($tags as $tag):?>
						
						<option <?php if($circle[0]["about"] == $tag["id"]){echo "selected=selected";}?> value="<?php echo $tag["id"];?>"><?php echo $tag["title"];?></option>
			...
			<tr>
				...
				<td><input value="<?php echo $circle[0]["phone"];?>" id="list_phone" class="circle_editor_input big_input required" type="text" id="circles_phone" name="circles_phone" maxlength="50"></td>
			</tr>
			<tr>
				<th><label class="fr" for="circles_email">Email:*</label></th>
				<td>
				<input value="<?php echo $circle[0]["email"];?>" id="list_phone" class="circle_editor_input big_input required email" type="text" id="circles_email" name="circles_email" maxlength="50">
				<br />
				<font style="font-style:italic">This will allow us to be more motivated to communicate with you. We respect the personal privacy</font>
				</td>
			</tr>
			<tr>
				<th></th>
			...
			<tr>
				<th><input id="agree_terms" class="" type="checkbox" checked=checked/></th>
			...
			<tr>
				<th></th>
				<td>
				<a class="cancel_button fr" href="<?php echo runFunc('encrypt_url',array('action=share&method=circlePage&id='.$this->_tpl_vars["IN"]["id"]));?>">Cancel</a>
	...
	<div class="circle_msg_box gray_line_box fr">
...
and reserves the right to the dissolution of such topics circles.</p>
	...
	<p>Cicles need to complete to create through the audit, the 

administrator will audit within two days apply for the audit 

results will be bean-mail to inform you, please be patient.</p>
	</div>
	</div>
...
<script type="text/javascript">
	...
	$(function(){
		...
		$("#introduction").keyup(function(){
			...
			$("#circle_tags_box .circle_create_tags").click(function(){

					$(this).remove();
				});

			$(".circle_create_tags_select_box .circle_create_tags").click(function(){
