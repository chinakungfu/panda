...
?>
 ...
 foreach ($this->_tpl_vars["allList"]["data"] as $this->_tpl_vars['key']=>$this->_tpl_vars['var']){ ?>
                <tr>
                  <td style="text-align:left; padding-left:10px;"><?php echo $this->_tpl_vars["var"]["title"];?></td>
                  <td><?php echo $this->_tpl_vars["var"]["author"];?></td>
  ...
  <?php
$_tmp13240177494196=$this->_tpl_vars;
...
include($inc_tpl_file);
$this->_tpl_vars=$_tmp13240177494196;
unset($_tmp13240177494196);
?>
