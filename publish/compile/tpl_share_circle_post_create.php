...
<body onload="window.location.hash = 'here'">
	...
	?>
	<div class="content">
	<h2 class="cp_title">WOW Bazaar</h2>
	<h3 class="circle_create_box_title">Create Your Post <span style="font-size:12px;">in <font style="color:#5E97ED"><?php echo $circle[0]["name"];?></font></span></h3>
	...
	<form id="post_create_form" action="index.php" method="post">
		<input type="hidden" name="circle_id" value="<?php echo $this->_tpl_vars["IN"]["id"];?>"/>
		<table class="circle_create_detail_table">
			<tr>
				...
				<td>
				<input id="post_name" class="circle_editor_input big_input required" type="text" name="post_name" maxlength="50">
				<br>
			...
			<tr>
				...
				<td>
					<textarea class="circle_text required" name="comment" id="comment" style="height: 300px;" cols="30" rows="10"></textarea>
			...
			<tr>
				<th></th>
				<td>
				<a href="<?php echo runFunc('encrypt_url',array('action=share&method=circlePage&id='.$this->_tpl_vars["IN"]["id"]))?>" class="cancel_button fr" href="">Cancel</a>
