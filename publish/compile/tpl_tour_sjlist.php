...
$this->_tpl_vars['sjstoreList'] = CMS::CMS_list($params); 
    $this->_tpl_vars['PageInfo'] = &$PageInfo;  
?>
            		<?php if(!empty($this->_tpl_vars["sjstoreList"]["data"])){ 
 foreach ($this->_tpl_vars["sjstoreList"]["data"] as $this->_tpl_vars['key']=>$this->_tpl_vars['var']){ ?>    
                    	<li><a href="<?php echo $this->_tpl_vars["var"]["url"];?>" title="<?php echo $this->_tpl_vars["var"]["title"];?>"><img src="../web-inf/lib/coreconfig/<?php echo $this->_tpl_vars["var"]["photo"];?>" border="0" /></a><a href="<?php echo $this->_tpl_vars["var"]["url"];?>" title="<?php echo $this->_tpl_vars["var"]["title"];?>"><?php echo runFunc('CsubStr',array( $this->_tpl_vars["var"]["title"] , 0, 8));?><br>&nbsp;<?php echo $this->_tpl_vars["var"]["subTitle"];?>&nbsp;</a></li>
                	<?php  }
} ?>
                    </ul>
                </div>
                <div class="page">
                    <?php $this->_tpl_vars["listPage"]=runFunc('listPageUrl',array($this->_tpl_vars["sjstoreList"]["pageinfo"],'../publish/index.php',10,"nodeId={$this->_tpl_vars["IN"]["nodeId"]}")); ?>
                    <?php
$_tmp13240177481809=$this->_tpl_vars;
...
include($inc_tpl_file);
$this->_tpl_vars=$_tmp13240177481809;
unset($_tmp13240177481809);
?>
