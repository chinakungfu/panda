...
<body onload="window.location.hash = 'here'">
	...
	$item = runFunc("getSiteGroupBuyItem",array($this->_tpl_vars["IN"]["id"]));
	$purchase_count = runFunc("getGroupPurchasedCount",array($this->_tpl_vars["IN"]["id"]));
	$comments = runFunc("getComment",array($this->_tpl_vars["IN"]["id"],"GROUP BUY GOODS"));
	...
	$(function(){
		...
		var item_img_ctrl = new Array();
			...
			<?php list($good_img_width,$good_img_height) = getimagesize($item[0]["goodsImgURL4"]."_600x600.jpg");?>
	...
	<div class="content">
		<div class="full_width_box oh">
			<div class="publish_item_left fl">
				<h2 class="cp_title" style="margin-bottom:5px">Group Buy</h2>
				...
				<?php 
						...
						$nav_id = runFunc("getGroupItemNavGroup",array($this->_tpl_vars["IN"]["id"]));
			...
			<div class="item_created">
				...
				<?php if($item[0]["sell_way"]==2){
					...
					<?php 
							...
							?>
							<?php $this->_tpl_vars["paraStr"]=serialize($this->_tpl_vars["paraArr"]); ?>
					<div style="margin-top: 30px; float: right;">Please <a style="color:#5E97ED" href="<?php echo runFunc('encrypt_url',array('action=website&method=login&loginType=itemShow&paraStr='.$this->_tpl_vars["paraStr"] ));?>">Login</a> To Buy</div>
					<?php endif;?>
					<?php }else{?>
						 <?php if ($this->_tpl_vars["name"]):?>
				...
				<?php if($this->_tpl_vars["IN"]["from"] != "search_url"):?>
					<div class="publish_item_ctrl_button fl">
						...
						<?php $love_count = runFunc("getShareListLoveCount",array($this->_tpl_vars["IN"]["id"],"GROUP BUY ITEM"));?>
						<?php $check_love = runFunc("checkMemberLove",array($this->_tpl_vars["IN"]["id"],$this->_tpl_vars["name"],"GROUP BUY ITEM"));
						?>
		...
		var member_id = <?php echo $this->_tpl_vars["name"];?>
			...
			$(".love_it_button").click(function(){
				if(loving == 1){
					...
					makeLove(<?php echo $this->_tpl_vars["IN"]["id"];?>,'<?php echo $this->_tpl_vars["name"];?>',"GROUP BUY ITEM",$(this),false);
				}
			});
