...
<?php if ($this->_tpl_vars["name"]==''){
		...
		$this->_tpl_vars["paraArr"]["backMethod"] = "item_show";
		...
		header("Location: ".runFunc('encrypt_url',array('action=website&method=login&loginType=addCart&paraStr=' . $this->_tpl_vars["paraStr"])));
		exit;
	 }else{
...
<?php if($this->_tpl_vars["addCartTable"]){
	...
	<!--header("Location: ".runFunc('encrypt_url',array('action=surprise&method=item_show&id='.$this->_tpl_vars["IN"]["goodsID"].'&show_type=normal&from=search_url')));-->
