...
?>
 ...
 foreach ($this->_tpl_vars['data'] as $this->_tpl_vars['key']=>$this->_tpl_vars['var']){ ?>
                <tr>
                  <td><?php echo $this->_tpl_vars["var"]["planName"];?></td>
                  <td><?php echo $this->_tpl_vars["var"]["planUnit"];?></td>
                  <td><?php echo $this->_tpl_vars["var"]["startTime"];?></td>
                  <td><?php echo $this->_tpl_vars["var"]["spUnit"];?></td>
                  <td><?php echo $this->_tpl_vars["var"]["spTime"];?></td>
                  <td><?php echo $this->_tpl_vars["var"]["spFileNum"];?></td>
