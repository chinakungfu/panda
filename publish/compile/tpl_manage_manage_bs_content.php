...
?>
    ...
    <div class="block">
   	  <div class="bcbox">
   		  <div class="topt"><div class="fontbox">◎ <?php echo $this->_tpl_vars["listcontent"]["title"];?></div><div style="font-size:12px; line-height:25px; color:#F00;">&nbsp;&nbsp;<?php echo $this->_tpl_vars["listcontent"]["author"];?>发布</div></div>
          <div class="cbox">
            <table cellpadding="0" cellspacing="0" width="770" align="center">
                <tr>
                  <td valign="top" class="introfont"><?php echo $this->_tpl_vars["listcontent"]["content"];?></td>
                </tr>
            </table>
          </div>
      </div>
