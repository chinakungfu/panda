...
<div class="content">
		...
		<div class="address_manage">
				<div id="cartTwoContent">
                    <div id="addressCreate">
                        ...
                        <div class="addresscont">
                               <table border="0" width="925px" class="addresstab">
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="text" style="color:#000;" name="email" id="email"  value="" />
                                        </td>
                                    </tr> 
                                    <tr>
                                        <td align="right"><input type="checkbox" name="isdefault" id="isdefaultCheckBox" checked="checked" value="1" style="width:20px;margin-right:20px;" /></td>
