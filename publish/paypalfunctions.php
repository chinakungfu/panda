...
$shipToCountryCode, $shipToZip, $shipToStreet2, $phoneNum,$items, $orderNo 
)
{
	//------------------------------------------------------------------------------------------------------------------------------------
	// Construct the parameter string that describes the SetExpressCheckout API call in the shortcut implementation
...
//	$nvpstr = $nvpstr . "&ADDROVERRIDE=1";
	...
	$nvpstr = $nvpstr . "&PAYMENTREQUEST_0_INVNUM=".$orderNo;
	$nvpstr = $nvpstr . "&L_PAYMENTREQUEST_0_NAME0=WOW ORDER PAY
...
function hash_call($methodName,$nvpStr)
{
	...
	$SandboxFlag = $settings[0]["SandboxFlag"];
	...
	//'------------------------------------
	$API_UserName=$settings[0]["API_UserName"];
	$API_Password=$settings[0]["API_Password"];
	$API_Signature=$settings[0]["API_Signature"];
