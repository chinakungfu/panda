...
<input type="hidden" name="resourceUrl" value="<?php echo $this->_tpl_vars["resourceUrl"];?>">
<input type="hidden" class="edit" name="isText" value="<?php echo $this->_tpl_vars["isText"];?>">
<input type="hidden" class="edit" name="isId" value="<?php echo $this->_tpl_vars["isId"];?>">
<input type="hidden" class="edit" name="para[appid]" value="<?php echo $this->_tpl_vars["IN"]["appName"];?>">
<input type="hidden" class="edit" name="prePath" value="<?php echo $this->_tpl_vars["IN"]["prePath"];?>">
<input type="hidden" class="edit" name="para[resourceName]" value="">
<input type="hidden" class="edit" name="fileFolder" value="<?php echo $this->_tpl_vars["IN"]["appName"];?>/<?php echo $this->_tpl_vars["IN"]["location"];?>">
